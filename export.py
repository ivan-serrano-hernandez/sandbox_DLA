...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov9-s.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.5, help='ONNX END2END/TF.js NMS: confidence threshold')
    parser.add_argument(
        '--include',
        nargs='+',
        default=['onnx'],
